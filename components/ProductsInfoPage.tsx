    ...
    return (
        <div className="border-b border-[#E2D7C8]">
            ...
            >
                ...
                <FiChevronDown
                    size={15}
                    className={`text-[#B85C38] transition-transform duration-300 flex-shrink-0 ${open ? 'rotate-180' : ''}`}
                />
            </button>
    ...
    return (
        <div ref={pageRef} className="min-h-screen bg-[#F7F2E9]">
            <div className="max-w-7xl mx-auto px-6 lg:px-14 pt-28 pb-6">
                {/* ── Breadcrumb ──────────────────────────────────────────── */}
                <nav
                    className="flex items-center gap-2 mb-8 text-[11px] text-[#8A7060]"
                    style={{ fontFamily: "'Jost', sans-serif" }}
                >
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-14 pb-12">
                <div className="grid lg:grid-cols-2 gap-12 xl:gap-20">
                    ...
                    <div ref={imageRef}>
                        {/* Main image */}
                        <div className="relative rounded-sm overflow-hidden h-[460px] lg:h-[540px] mb-4 bg-[#EDE3D4]">
                            <Image
                            ...
                            {product.tag && (
                                <Badge
                                    className="absolute top-5 left-5 rounded-none text-[9px] tracking-[0.18em] uppercase px-3 py-1 border-0 bg-[#B85C38] text-[#F7F2E9] z-10"
                                    style={{ fontFamily: "'Jost', sans-serif" }}
                                >
                                    {product.tag}
                                </Badge>
                            ...
                            {/* Discount pill */}
                            {discount > 0 && (
                                <div className="absolute top-5 right-5 h-12 w-12 rounded-full bg-[#C9A86C] flex flex-col items-center justify-center z-10">
                                    <span
                                        className="text-[#1E130C] font-bold text-[13px] leading-none"
                                        style={{ fontFamily: "'Jost', sans-serif" }}
                                    >
                                        {discount}%
                                    </span>
                                    <span
                                        className="text-[#1E130C]/60 text-[8px] leading-none"
                                        style={{ fontFamily: "'Jost', sans-serif" }}
                                    >
                                        OFF
                                    </span>
                            ...
                            <div className="absolute bottom-5 right-5 z-10">
                                <button className="h-9 w-9 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/40 transition-all duration-300">
                                    <FiShare2 size={14} />
                                </button>
                            </div>
                        </div>

                        {/* Thumbnails — clicking switches the main image */}
                        <div className="grid grid-cols-4 gap-3">
                            {product.images.map((src, i) => (
                                <button
                                    key={i}
                                    onClick={() => setActiveImage(i)}
                                    className={`relative h-[72px] rounded-sm overflow-hidden bg-[#EDE3D4] transition-all duration-200 ${
                                        i === activeImage
                    ...
                    <div ref={infoRef} className="flex flex-col gap-5">
                        ...
                        <div className="flex items-baseline gap-3">
                            ...
                            {product.originalPrice && (
                                <>
                                    <span
                                        className="text-[#8A7060] line-through text-base"
                                        style={{ fontFamily: "'Jost', sans-serif" }}
                                    >
                        ...
                        <div className="flex items-center gap-3 mt-1">
                            ...
                            <Button
                                ...
                                className="cart-btn-info flex-1 bg-[#1E130C] hover:bg-[#B85C38] text-white rounded-none h-12 tracking-widest uppercase text-[10px] transition-all duration-300 flex items-center justify-center gap-2 border-0 font-medium"
                                style={{ fontFamily: "'Jost', sans-serif" }}
                            >
