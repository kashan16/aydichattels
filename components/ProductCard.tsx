...
import { CATEGORY_ICONS, getProductsByCategory } from '@/lib/products'
...
export default function ProductInfoPage({ product }: { product: Product }) {
    ...
    // FIX: product.icon was removed — functions can't cross the server→client boundary.
    // Resolve the icon client-side from the category string instead.
